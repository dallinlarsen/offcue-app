...
const CheckboxBlankOutlineIcon = createIcon({
  Root: Svg,
  viewBox: "0 0 24 24",
  path: (
    <>
...
const CheckboxMarkedIcon = createIcon({
  Root: Svg,
  viewBox: "0 0 24 24",
  path: (
    <>
...
export { CheckboxBlankOutlineIcon, CheckboxMarkedIcon };
...
const VolumeHighIcon = createIcon({
  Root: Svg,
  viewBox: "0 0 24 24",
  path: (
    <>
