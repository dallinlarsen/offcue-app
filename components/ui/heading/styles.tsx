...
export const headingStyle = tva({
  ...
  variants: {
    ...
    size: {
      ...
      "3xl": "text-4xl",
      "2xl": "text-3xl",
      xl: "text-2xl font-quicksand-medium",
      lg: "text-xl font-quicksand-medium",
      md: "text-lg font-quicksand-medium",
      sm: "text-base font-quicksand-medium",
      xs: "text-sm font-quicksand-medium",
    },
  },
});
